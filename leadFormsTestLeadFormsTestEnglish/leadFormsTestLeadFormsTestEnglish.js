...
import { OMNIDEF } from './leadFormsTestLeadFormsTestEnglish_def.js';
import tmpl from './leadFormsTestLeadFormsTestEnglish.html';
import tmpl_nds from './leadFormsTestLeadFormsTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class leadFormsTestLeadFormsTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
