...
import { OMNIDEF } from './telemedFormsTelemedFormsEnglish_def.js';
import tmpl from './telemedFormsTelemedFormsEnglish.html';
import tmpl_nds from './telemedFormsTelemedFormsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class telemedFormsTelemedFormsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
