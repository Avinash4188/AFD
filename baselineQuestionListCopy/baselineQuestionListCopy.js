...
import getQuestionsAndResponsesByMedicalCondition from '@salesforce/apex/BaselineQuestionPortalHandler.getQuestionsAndResponsesByMedicalCondition';
import saveResponses from '@salesforce/apex/BaselineQuestionPortalHandler.saveResponses';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
const QUESTIONS_PER_PAGE = 6; // Number of questions to display per page

export default class BaselineQuestionListCopy extends LightningElement {
    ...
    fetchQuestions() {
        getQuestionsAndResponsesByMedicalCondition({ accountId: this.accountId })
            .then(result => {
